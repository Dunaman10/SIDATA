    ...
    <div class="flex items-start gap-4 p-4 rounded-xl border border-warning-500/40 bg-warning-50/50 dark:bg-warning-950/20">
      ...
      <div class="flex-1 space-y-1">
        ...
        <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          Untuk menjaga performa server, <strong>seluruh data setoran hafalan anak</strong> (termasuk file Audio & Foto) akan <span class="font-bold text-danger-600 dark:text-danger-400">dihapus secara otomatis dan permanen</span> setiap pergantian semester.
        </p>

        <div class="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div class="rounded-lg bg-white dark:bg-gray-800 px-4 py-2 border border-gray-200 dark:border-gray-700">
            <p class="text-xs text-gray-500 dark:text-gray-400">Total Data Hafalan Anak</p>
        ...
        <p class="text-xs text-gray-500 dark:text-gray-400 mt-3 italic">
          💡 Pastikan Anda sudah mendownload arsip data hafalan anak Anda secara berkala dengan menekan tombol <strong>"Download Arsip Hafalan Anak"</strong> di atas sebelum data terhapus.
        </p>
      </div>
    </div>
  </x-filament::section>
