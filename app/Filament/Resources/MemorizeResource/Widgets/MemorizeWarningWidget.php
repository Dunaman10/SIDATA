...
namespace App\Filament\Resources\MemorizeResource\Widgets;

use App\Models\Memorize;
use Carbon\Carbon;
use Filament\Widgets\Widget;

class MemorizeWarningWidget extends Widget
{
  protected static string $view = 'filament.resources.memorize-resource.widgets.memorize-warning-widget';
  ...
  {
    $this->totalRecords = Memorize::count();
