...
use App\Filament\Parent\Resources\MemorizeResource\Pages;
...
class MemorizeResource extends Resource
{
  ...
  protected static ?string $pluralLabel = 'Arsip Hafalan Anak';
  ...
  // Filter: hanya data hafalan anak milik orang tua yang login
            ...
            return $infolist
              ->schema([
                ...
                \Filament\Infolists\Components\Section::make('Penilaian Hafalan')
                  ->description('Bagian ini berisi nilai dan kualitas bacaan anak')
                  ->schema([
